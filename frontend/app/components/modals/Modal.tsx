...
const Modal: React.FC<ModalProps> = ({
  ...
  return (
    <>
      <div className="justify-center items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none bg-neutral-800/75">
        <div className=" relative w-full md:w-4/5 lg:w-3/6 xl:w-2/5 my-6 mx-auto h-full lg:h-auto md:h-auto">
          ...
          >
            <div className="tranlate h-full lg:h-auto md:h-auto border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
              <div className=" flex items-center p-7 rounded-t justify-center relative border-b-[1px]">
                <button
                  onClick={handleClose}
